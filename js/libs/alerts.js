...
function AlertLibrary() {
    ...
    AlertLibrary.prototype.successAlertComplain = function (parent, action) {
        ...
        let textAlert = document.createElement('p');
        textAlert.className = 'textAlert';
        textAlert.innerHTML = 'Complaint successfully sent';
        alertDiv.appendChild(textAlert);
    ...
    AlertLibrary.prototype.successAlertDisconect = function (parent, action) {
        ...
        let textAlert = document.createElement('p');
        textAlert.className = 'textAlert';
        textAlert.innerHTML = 'Cancelation request completed';
        alertDiv.appendChild(textAlert);
    ...
    AlertLibrary.prototype.successAlertPayment = function (parent, action) {
        ...
        let textAlert = document.createElement('p');
        textAlert.className = 'textAlert';
        textAlert.innerHTML = 'Payment successfully created';
        alertDiv.appendChild(textAlert);
